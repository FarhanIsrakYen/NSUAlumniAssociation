...
<div class="wrapper">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{!! url('home') !!}"><i class="pe-7s-users"></i> User Profile</a></li>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="#">On Trial</a>.</strong> All rights reserved. <i class="fa fa-heart color-green"></i>
    </footer>
</div>
<!-- ./wrapper -->
<!-- Start Core Plugins
